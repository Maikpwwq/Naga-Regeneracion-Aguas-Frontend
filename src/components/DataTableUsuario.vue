...
<template>
  <v-data-table id="dataTableUsuario" :headers="headers" :items="usuarios" sort-by="id" class="elevation-1"
    :loading="cargando" loading-text='Cargando por favor espere'>
    <template v-slot:top>
      <v-toolbar flat>
              ...
              <v-container>
                <v-row>
                  ...
                  <v-col cols="12" sm="12" md="12">
                    <v-textarea v-model="editedItem.id" label="ID" counter="64" no-resize></v-textarea>
                  </v-col>

                  <v-col cols="12" sm="12" md="12">
                    <v-textarea v-model="editedItem.nombre" label="Nombre" counter="64" no-resize></v-textarea>
                  </v-col>

                  <v-col cols="12" sm="12" md="12">
                    <v-textarea v-model="editedItem.email" label="E-mail" counter="254" no-resize auto-grow>
                    </v-textarea>
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                  ...
                  <v-col cols="12">
                    <v-text-field ref="Pass" v-on:input="editedItem.password = $event" label="Password"></v-text-field>
                  </v-col>
