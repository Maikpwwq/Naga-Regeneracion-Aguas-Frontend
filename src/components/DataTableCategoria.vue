...
<template>
  <v-data-table id="dataTableCategoria" :headers="headers" :items="categorias" sort-by="nombre" class="elevation-1"
              ...
              <v-container>
                <v-row>
                  <v-col cols="12" sm="12" md="12">
                    <v-textarea v-model="editedItem.nombre" label="Categoria" counter="64" no-resize></v-textarea>
                  </v-col>
                  <v-col cols="12" sm="12" md="12">
                    <v-textarea v-model="editedItem.descripcion" label="Descripcion" counter="254" no-resize auto-grow>
                    </v-textarea>
                  </v-col>
                </v-row>
              </v-container>
